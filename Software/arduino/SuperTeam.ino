...
// ---------- TOUCH SENSOR ----------
// void TouchSensor() {
//   currentSwitchState = digitalRead(touchPin)
...
// void AccordTouch() {
//   if (NumberofTouchs == 1) {
//     //Serial.print(NumberofTouchs) left
//   } else if(NumberofTouchs == 2) {
//     //Serial.print(NumberofTouchs) center
//   } else if (NumberofTouchs == 3) {
//     //Serial.print(NumberofTouchs) right
//   }

//   return NumberofTouchs
// }
...
void UMessage() { //Sube el servo a una altura para depositar
  lift_servo.write(LIFT_SERVO_MEDIUM);
}

void HMessage() { // Suelta la pelota
  right_claw.write(RIGHT_OPEN);
  left_claw.write(LEFT_OPEN);
}
...
void loop()
{
    ...
    if (Acm.isReady())
    {
        ...
        if (modo == "line" && (currentMillis - previousMillis) >= interval)
        {
            ...
            //   rawValue = 241;
            //   rcode = Acm.SndData(1, &rawValue);
            //   rcode = Acm.SndData(1, &NumberofTouchs);
            // }
